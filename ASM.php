...
if (isset($_SESSION['user_id'])) {
    try {
        ...
        if (!$user) {
            ...
            header("Location: index.php?redirect=ASM.php");
            exit;
        }
...
<head>
    ...
    <title>Food Order - Cao Bang Food</title>
        ...
        <div class="header">
            <div class="row align-items-center">
                <div class="col-6 col-md-2">
                    <div class="logo">
                        <img src="https://thachan.vn/theme/wbthachan/wp-content/uploads/2023/10/thach-an-caobangfood.jpg" alt="Cao Bang Food Logo">
                    </div>
                </div>
                ...
                <div class="col-6 col-md-2 d-flex justify-content-end">
                    ...
                    <div class="account dropdown">
                        ...
                        <?php else: ?>
                            <a href="index.php?redirect=ASM.php" class="btn btn-primary">Log in</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <?php if (!$user): ?>
                            <p class="text-center">Please <a href="index.php?redirect=ASM.php">log in</a> to view cart or place order.</p>
                        <?php else: ?>
                ...
                <div class="col-lg-9 col-md-8">
                    <div id="foodCarousel" class="carousel slide mb-4" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item">
                                <img src="https://autourasia.com/uploads/Travel-Guide-Vietnam/caobang/discover-12-famous-delicacies-in-cao-bang/700-hat-de-trung-khanh-cao-bang.jpg" class="d-block w-100" alt="Food Promotion 3">
                                <div class="carousel-caption d-none d-md-block">
                        ...
                        <?php foreach ($menu_items as $item): ?>
                            <div class="product-item" data-id="<?php echo htmlspecialchars($item['id'], ENT_QUOTES, 'UTF-8'); ?>" 
                                ...
                                <div class="product-buttons">
                                    ...
                                    <?php else: ?>
                                        <a href="index.php?redirect=ASM.php" class="btn btn-success">Log in to Add</a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        <?php endforeach; ?>
